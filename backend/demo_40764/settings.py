"""
Django settings for demo_40764 project.
...
WSGI_APPLICATION = 'demo_40764.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo_40764 API",
    "DESCRIPTION": "API documentation for demo_40764 App",
    "VERSION": "v1",
}
